//! Layer 1 — Allocator-free JSON writer.
//!
//! The zpm json module reads JSON; sls also needs to *emit* it for responses
//! and notifications. This is a minimal streaming writer over a caller-provided
//! fixed buffer. It performs correct string escaping and reports overflow via
//! error rather than allocating. No I/O — callers frame and write the bytes.
...
pub const Writer = struct {
    ...
    /// Write a JSON string literal with proper escaping (quotes included).
    ...
    /// Write `"key":` — caller follows with a value.
